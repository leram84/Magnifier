...
5. Under **Artifacts**, select the newest **magnifeye-v1.2-build-N** artifact.
...
6. Extract the ZIP and open the similarly named
   `Magnifeye-v1.2-build-N.apk` on the Android device.
...
The workflow disables Gradle caching, deletes all previous build output, and
forces every task to run again. The app displays `v1.2` at the top of its camera
