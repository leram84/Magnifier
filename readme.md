...
5. Under **Artifacts**, select the newest **magnifeye-v1.3-build-N** artifact.
...
6. Extract the ZIP and open the similarly named
   `Magnifeye-v1.3-build-N.apk` on the Android device.
...
again. The app displays `v1.3` at the top of its camera
